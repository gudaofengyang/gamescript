...
if not cli_setup():
#     auto_setup(__file__, logdir=None, devices=["android://127.0.0.1:5037/16021JEC203290?cap_method=JAVACAP&&ori_method=MINICAPORI&&touch_method=MINITOUCH",])
...
ui.setStyleSheet("#jiaoben{background-image:url(backscene.jpg);background-repeat:repeat;background-color:rgba(0,0,0,0.5);}")
